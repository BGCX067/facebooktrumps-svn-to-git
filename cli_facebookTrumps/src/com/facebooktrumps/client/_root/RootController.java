...
public class RootController extends Controller {
	...
	private Triad 			 			createGame;
	private Triad							playGame;	 
	private Triad						    endGame;	 
	private Triad							browser;
			...
			public void handleEvent(Event event) {
				...
				switch (((Integer) event.getPayload()).intValue()) {
		 			...
		 			case RootControllerEvent.ENDGAME: 
		 			    ...
		 			    RootPanel.get("mainPanel").add(new HTML("We have a winner!"));
	...
	private void cleanUp() {
		...
		if (createGame != null) createGame.destroy();
		if (playGame != null) createGame.destroy();
		if (endGame != null) endGame.destroy();
	}
